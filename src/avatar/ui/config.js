...
const CONFIG = {
  // API Endpoints
  CHARACTER_API_URL: window.location.protocol + "//" + window.location.host + "/proxy/gateway",
  LIVEPORTRAIT_API_URL:
    window.location.protocol + "//" + window.location.host + "/proxy/liveportrait",
  TTS_URL: window.location.protocol + "//" + window.location.host + "/proxy/tts",
  STT_URL: window.location.protocol + "//" + window.location.host + "/proxy/stt",
...
if (urlParams.has("tts_url")) {
  CONFIG.TTS_URL = urlParams.get("tts_url");
}

if (urlParams.has("stt_url")) {
  CONFIG.STT_URL = urlParams.get("stt_url");
}
