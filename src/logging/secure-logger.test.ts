...
describe("SecureLogger", () => {
  ...
  describe("Redaction Only", () => {
    it("should redact credentials by default", () => {
      ...
      const spy = vi.fn();
      (
        logger as unknown as Record<string, Record<string, ReturnType<typeof vi.fn>>>
      ).baseLogger.info = spy;
    ...
    it("should redact multiple credentials", () => {
      ...
      const message =
        "Key: sk-1234567890abcdefghijklmnopqrstuvwxyz Password: MySecret123 Token: ghp_abcdefghijklmnopqrstuvwxyz123456";
  ...
  describe("Log Levels", () => {
    it("should support all log levels", () => {
      ...
      for (const level of levels) {
        const spy = vi.fn();
        (logger as unknown as Record<string, Record<string, ReturnType<typeof vi.fn>>>).baseLogger[
          level
        ] = spy;
