...
export class TypedEventBus {
   ...
   */
  publish<K extends keyof SystemEventMap>(eventType: K, payload: SystemEventMap[K]): void {
   ...
   */
  subscribe<K extends keyof SystemEventMap>(eventType: K, handler: EventHandler<K>): Unsubscribe {
   ...
   */
  once<K extends keyof SystemEventMap>(eventType: K, handler: EventHandler<K>): Unsubscribe {
    const wrappedHandler = async (event: SystemEvent<K>) => {
      this.stats.totalEventsDelivered++;
