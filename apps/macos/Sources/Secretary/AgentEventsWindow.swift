...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: SecretaryProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": SecretaryProtocol.AnyCodable("start"),
                "name": SecretaryProtocol.AnyCodable("bash"),
            ],
            summary: nil)
