...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.secretary", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SecretaryConfigFile.defaultWorkspaceURL() }
