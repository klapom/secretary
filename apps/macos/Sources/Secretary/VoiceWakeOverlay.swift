...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.secretary", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Secretary windows, but below the system’s pop-up menus.
