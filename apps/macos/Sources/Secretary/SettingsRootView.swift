...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .secretarySelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SecretaryPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SecretaryPaths.stateDirURL.path
...
extension Notification.Name {
    static let secretarySelectSettingsTab = Notification.Name("secretarySelectSettingsTab")
}
