...
enum SecretaryConfigFile {
    private static let logger = Logger(subsystem: "ai.secretary", category: "config")
    ...
    static func stateDirURL() -> URL {
        SecretaryPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SecretaryPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-secretary-config-file",
            "event": "config.write",
