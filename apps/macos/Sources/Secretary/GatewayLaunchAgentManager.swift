...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.secretary", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".secretary/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.secretaryCommand(
            subcommand: "gateway",
