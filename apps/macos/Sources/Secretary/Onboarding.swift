...
enum UIStrings {
    static let welcomeTitle = "Welcome to Secretary"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "secretary.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: SecretaryOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: SecretaryChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g secretary@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SecretaryChatViewModel(
