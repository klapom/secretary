...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/secretary/secretary") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/secretary/secretary")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://secretary.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "SecretaryBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SecretaryBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SecretaryGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SecretaryGitCommit") as? String) ??
            "unknown"
    }
