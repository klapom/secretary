...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SecretaryConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SecretaryConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SecretaryConfigFile.loadDict()
            ...
            SecretaryConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/secretary"
        state.remoteCliPath = ""
        return state
    }
}
