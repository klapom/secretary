...
extension ProcessInfo {
    ...
    /// Nix deployments may write defaults into a stable suite (`ai.secretary.mac`) even if the shipped
        ...
        isAppBundle: Bool) -> Bool
    {
        ...
        if standard.bool(forKey: "secretary.nixMode") { return true }
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "secretary.nixMode") { return true }
