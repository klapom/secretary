...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.secretary", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.secretary", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [SecretaryChatMessage] = messages.compactMap { item in
