...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.secretary", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Secretary/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__secretary__/a2ui/").absoluteString + "?platform=macos"
    }
