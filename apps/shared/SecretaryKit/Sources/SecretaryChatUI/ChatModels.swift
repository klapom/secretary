...
public typealias SecretaryPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SecretaryPlatformImage = UIImage
#endif

public struct SecretaryChatUsageCost: Codable, Hashable, Sendable {
...
public struct SecretaryChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SecretaryChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SecretaryChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SecretaryChatMessageContent: Codable, Hashable, Sendable {
...
public struct SecretaryChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SecretaryChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SecretaryChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SecretaryChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SecretaryChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(SecretaryChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([SecretaryChatMessageContent].self, forKey: .content) {
...
public struct SecretaryChatHistoryPayload: Codable, Sendable {
...
public struct SecretarySessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SecretarySessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SecretarySessionPreviewItem]
}

public struct SecretarySessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SecretarySessionPreviewEntry]

    public init(ts: Int, previews: [SecretarySessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SecretaryChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SecretaryChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SecretaryAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SecretaryChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct SecretaryGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SecretaryPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SecretaryPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: SecretaryPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct SecretaryChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
