...
public struct SecretaryChatView: View {
    ...
    @State private var viewModel: SecretaryChatViewModel
    ...
    public init(
        viewModel: SecretaryChatViewModel,
    ...
    private var visibleMessages: [SecretaryChatMessage] {
        let base: [SecretaryChatMessage]
    ...
    private func mergeToolResults(in messages: [SecretaryChatMessage]) -> [SecretaryChatMessage] {
        ...
        for message in messages {
            ...
            let merged = SecretaryChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: SecretaryChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SecretaryChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SecretaryChatMessage) -> String {
