...
public enum SecretaryCanvasA2UICommand: String, Codable, Sendable {
...
public struct SecretaryCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SecretaryCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
