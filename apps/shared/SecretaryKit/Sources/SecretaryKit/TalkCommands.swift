...
public enum SecretaryTalkCommand: String, Codable, Sendable {
...
public struct SecretaryTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct SecretaryTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
