...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.secretary", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.secretary", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SecretaryProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
