...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = SecretaryChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = SecretaryChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
